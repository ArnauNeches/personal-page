export const publications = [
  {
    id: 'caepia-2026-feature-selection',
    title: 'Lookahead and Dynamic Beam Search Variants of FOCI for Conditional-Dependence Feature Selection',
    venue: 'CAEPIA 2026',
    status: 'Accepted',
  ...
  {
    id: 'caepia-2026-chronos-benchmark',
    title: 'Benchmarking Chronos-2 as a Foundation Model for Traffic Forecasting',
    venue: 'CAEPIA 2026',
    status: 'Accepted',
